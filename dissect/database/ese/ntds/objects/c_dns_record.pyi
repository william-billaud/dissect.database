...
class _c_dns_record(__cs__.cstruct):
    ...
    class DNS_RPC_RECORD_SOA(__cs__.Structure):
        ...
        @overload
        def __init__(self, Serial: _c_dns_record.uint32 | None = ..., Refresh: _c_dns_record.uint32 | None = ..., Retry: _c_dns_record.uint32 | None = ..., Expire: _c_dns_record.uint32 | None = ..., MinimumTtl: _c_dns_record.uint32 | None = ..., namePrimaryServer: _c_dns_record.DNS_RPC_NAME | None = ..., _pad: _c_dns_record.uint8 | None = ..., ZoneAdministratorEmail: _c_dns_record.DNS_RPC_NAME | None = ...): ...
        @overload
        def __init__(self, fh: bytes | memoryview | bytearray | BinaryIO, /): ...

...
from dissect.database.ese.c_ese import CODEPAGE, IDBFLAG, IDXFLAG, JET_coltyp
from dissect.database.ese.cursor import Cursor
from dissect.database.ese.lcmapstring import map_string

if TYPE_CHECKING:
    from dissect.database.ese.page import Node, Page
    from dissect.database.ese.record import Record
    from dissect.database.ese.table import Column, Table
...
class Index:
    ...
    def root(self) -> Page:
        ...
        return self.db.page(self.record.get("ColtypOrPgnoFDP"))
    ...
    def search_key(self, key: bytes) -> Node:
        ...
        Returns:
            A :class:`~dissect.database.ese.page.Node` object of the found node.
        """
